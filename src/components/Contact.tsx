        ...
        <div className="w-full max-w-[1100px] justify-center flex gap-10 flex-col md:flex-row">
          ...
          {submitted ? <div className='flex justify-center  w-full items-center h-full'>
            ...
            : <form onSubmit={(e) => handleSubmit(e)} className="  rounded-lg md:items-center flex flex-col justify-evenly md:flex-row  w-full ">
              ...
              <div className="relative w-1/3 md:mb-0 mb-4">
              ...
              <input type="submit" className="h-[6.5vh] w-[16vh]  text-white justify-center  rounded transition duration-300 flex items-center gap-[10px] bg-[#06a987] hover:text-dark hover:bg-[white]" value="Send"/>
            </form>}
        </div>
      </div>
    </div>
